...
class ExerciseControllerTest extends TestCase
{
    ...
    public function test_show_exercise()
    {
        ...
        $responseErr = $this->get('/api/v1/exercise/' . $item->id + 1);
        $responseErr->assertStatus(404);
    }
    public function test_update_exercise()
    {
        ...
        $responseErr = $this->put('/api/v1/exercise/' . $item->id + 1, $data);
        $responseErr->assertStatus(404);
    }
    public function test_destroy_exercise()
    {
        ...
        $responseErr = $this->delete('/api/v1/exercise/' . $item->id + 1);
        $responseErr->assertStatus(404);
    }
}
